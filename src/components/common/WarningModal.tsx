...
// Sesuaikan import path gambar dengan struktur folder aslimu
...
export const WarningModal: React.FC<WarningModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            {/* Backdrop: Ditambah efek blur sedikit agar lebih fokus ke modal */}
            ...
            <div className="relative z-10 bg-white rounded-2xl shadow-xl px-8 py-10 max-w-sm w-full mx-4 flex flex-col items-center text-center animate-in fade-in zoom-in duration-200">
                ...
                {/* Tombol Native Pengganti Shadcn Button (Warna Warning/Kuning) */}
                <button 
                    onClick={onLogin} 
